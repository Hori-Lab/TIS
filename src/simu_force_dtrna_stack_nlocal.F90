!simu_force_dtrna_stack_nlocal
!> @brief Calculate forces related to stacking interaction of RNA particles.
!
! See simu_energy_dtrna_stack_nlocal.F90 for detail

subroutine simu_force_dtrna_stack_nlocal(irep, force_mp) 
...
end subroutine simu_force_dtrna_stack_nlocal
