!simu_force_dtrna_hbond13
!> @brief Calculate forces related to stacking interaction of RNA particles.
!
! See simu_energy_dt13_hbond.F90 for detail

subroutine simu_force_dtrna_hbond13(irep, force_mp) 
...
end subroutine simu_force_dtrna_hbond13
