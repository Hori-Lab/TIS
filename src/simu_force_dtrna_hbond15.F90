!simu_force_dtrna_hbond15
!> @brief Calculate forces related to stacking interaction of RNA particles.
!
! See simu_energy_dt15_hbond.F90 for detail

subroutine simu_force_dtrna_hbond15(irep, force_mp) 
...
end subroutine simu_force_dtrna_hbond15
